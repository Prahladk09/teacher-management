...
const Today = () => {
  ...
  const upcomingLessons = [
    { time: "10:00 AM", student: "Emma Johnson", subject: "Microservices Architecture", duration: "1h" },
    { time: "2:00 PM", student: "Michael Chen", subject: "Scalability & Load Balancing", duration: "1.5h" },
    { time: "4:00 PM", student: "Sarah Williams", subject: "Caching Strategies (Redis, CDN)", duration: "1h" },
    { time: "7:00 PM", student: "Peter Parker", subject: "System Design Interview Coaching", duration: "1h" },
  ]
