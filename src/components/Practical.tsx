...
const initialQualifications = [
  { name: "Scalability & Load Balancing", rate: "$50.00", level: "Advanced", years: 5 },
  { name: "Database Design & Sharding", rate: "$45.00", level: "Advanced", years: 4 },
  { name: "Caching Strategies (Redis, CDN)", rate: "$40.00", level: "Intermediate", years: 3 },
  { name: "Microservices Architecture", rate: "$55.00", level: "Expert", years: 6 },
  { name: "Message Queues & Event-Driven Systems", rate: "$50.00", level: "Advanced", years: 5 },
  { name: "CAP Theorem & Consistency Models", rate: "$35.00", level: "Intermediate", years: 2 },
  { name: "System Design Interview Coaching", rate: "$60.00", level: "Expert", years: 7 },
]
